...
- Every edge needs: `id` (unique string), `source`, `target`.
...
- You can only use the 5 supported node types (`manual_trigger`, `ai_analyze`, `condition`, `save_result`, `http_request`).
